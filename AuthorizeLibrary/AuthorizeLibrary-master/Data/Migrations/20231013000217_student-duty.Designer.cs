...
namespace PermissionBasedAuthorization.web.Data.Migrations
{
    ...
    [Migration("20231013000217_student-duty")]
    partial class studentduty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBModels.AppModels.Group", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DBModels.AppModels.StudentDuty", b =>
                {
                    b.HasOne("DBModels.AppModels.Group", "group")
                        .WithMany("groupDuties")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DBModels.AppModels.StudentTask", "task")
                        .WithMany("taskDuties")
            ...
            modelBuilder.Entity("DBModels.AppModels.StudentTask", b =>
                {
                    ...
                    b.HasOne("DBModels.AppModels.StudentTask", "parentTask")
